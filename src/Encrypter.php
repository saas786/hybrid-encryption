...
namespace Hybrid\Encryption;

use Hybrid\Contracts\Encryption\DecryptException;
use Hybrid\Contracts\Encryption\Encrypter as EncrypterContract;
use Hybrid\Contracts\Encryption\EncryptException;
use Hybrid\Contracts\Encryption\StringEncrypter;
...
class Encrypter implements EncrypterContract, StringEncrypter {
     ...
     * @throws \Hybrid\Contracts\Encryption\EncryptException
     */
    public function encryptString( #[\SensitiveParameter]
    $value ) {
     ...
     * @return string
     */
    protected function hash( #[\SensitiveParameter]
    $iv, #[\SensitiveParameter]
    $value, #[\SensitiveParameter]
    $key ) {
     ...
     * @return bool
     */
    protected function validMacForKey( #[\SensitiveParameter]
    $payload, $key ) {
        return hash_equals(
